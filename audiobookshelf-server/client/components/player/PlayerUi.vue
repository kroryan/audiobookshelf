  ...
  <div class="w-full -mt-6">
    <div class="w-full relative mb-1">
      <div class="absolute -top-10 lg:top-0 right-0 lg:right-2 flex items-center h-full">
        ...
        <ui-tooltip v-if="availableSubtitles.length" direction="top" :text="subtitlesEnabled ? 'Disable Subtitles' : 'Enable Subtitles'">
          <button :aria-label="'Subtitles'" class="outline-hidden mx-1 lg:mx-2 relative" @mousedown.prevent @mouseup.prevent @click.stop="toggleSubtitlesMenu">
            <span class="material-symbols text-2xl" :class="subtitlesEnabled ? 'text-success' : 'text-gray-300 hover:text-white'">closed_caption</span>
          </button>
        </ui-tooltip>
      ...
      <!-- Subtitles Menu -->
      <div v-if="showSubtitlesMenu && availableSubtitles.length" class="absolute bottom-12 right-2 bg-bg border border-white border-opacity-10 shadow-lg rounded-md py-2 z-60" style="min-width: 150px;">
        <button 
...
export default {
  ...
  methods: {
    ...
    selectSubtitleLanguage(language) {
      ...
      this.$emit('selectSubtitle', language)
    },
    ...
    handleClickOutside(e) {
      // Cerrar menú de subtítulos si se hace click fuera
      if (this.showSubtitlesMenu && !e.target.closest('.subtitles-menu-container')) {
        this.showSubtitlesMenu = false
      }
    }
  },
