...
export const mutations = {
  ...
  setShowSubtitlesModal(state, val) {
    state.showSubtitlesModal = val
  },
  setSubtitlesModal(state, libraryItem) {
    state.selectedLibraryItem = libraryItem
    state.showSubtitlesModal = true
  },
  ...
  setSelectedLibraryItem(state, libraryItem) {
    state.selectedLibraryItem = libraryItem
  },
