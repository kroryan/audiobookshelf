      ...
      <div class="flex flex-col lg:flex-row max-w-6xl mx-auto">
        ...
        <div class="grow px-2 py-6 lg:py-0 md:px-10">
          ...
          <div class="flex items-center justify-center md:justify-start pt-4">
            ...
            <ui-tooltip v-if="showSubtitlesButton" text="Subtítulos" direction="top">
              <ui-icon-btn icon="&#xe048;" outlined class="mx-0.5" aria-label="Subtítulos" @click="openSubtitlesModal" />
            </ui-tooltip>
...
export default {
  ...
  computed: {
    ...
    showSubtitlesButton() {
      return this.isBook && this.tracks.length > 0 && this.userCanUpdate
    },
    contextMenuItems() {
      const items = []
  ...
  methods: {
    ...
    openSubtitlesModal() {
      this.$store.commit('globals/setSubtitlesModal', this.libraryItem)
    },
