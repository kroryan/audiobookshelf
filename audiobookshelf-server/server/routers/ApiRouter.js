...
class ApiRouter {
  ...
  init() {
    ...
    //
    this.router.post('/items/:id/transcribe', TranscriptionController.middleware.bind(this), TranscriptionController.startTranscription.bind(this))
    this.router.get('/items/:id/transcription/status', TranscriptionController.middleware.bind(this), TranscriptionController.getTranscriptionStatus.bind(this))
    this.router.get('/items/:id/subtitles', TranscriptionController.middleware.bind(this), TranscriptionController.getSubtitles.bind(this))
    this.router.get('/items/:id/subtitles/:language/:format', TranscriptionController.middleware.bind(this), TranscriptionController.downloadSubtitle.bind(this))
    this.router.get('/items/:id/subtitles/:language/vtt', TranscriptionController.middleware.bind(this), TranscriptionController.serveSubtitleVTT.bind(this))
    this.router.get('/items/:id/subtitles/:language/srt', TranscriptionController.middleware.bind(this), TranscriptionController.serveSubtitleSRT.bind(this))
    this.router.delete('/items/:id/subtitles/:language', TranscriptionController.middleware.bind(this), TranscriptionController.deleteSubtitles.bind(this))
    this.router.post('/items/:id/subtitles/upload', TranscriptionController.middleware.bind(this), TranscriptionController.uploadSubtitles.bind(this))
    
    // General transcription endpoints
    this.router.get('/transcription/models', TranscriptionController.getAvailableModels.bind(this))
    this.router.get('/transcription/languages', TranscriptionController.getSupportedLanguages.bind(this))
